package com.sp45.newsly.presentation.common
...
import com.sp45.newsly.presentation.Dimens.IconSize
    ...
    Box(modifier = modifier) {
        TextField(
            ...
            colors = TextFieldDefaults.colors(
                // ✅ Text colors: white on dark theme, black on light theme
            ...
            textStyle = MaterialTheme.typography.bodySmall.copy(
                color = if (isDark) Color.White else Color.Black // ✅ force visible typing text
            ),
